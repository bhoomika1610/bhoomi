...
def create_app_ui():
    main_layout=html.Div(
        [   
            ...
            html.H1(id='img',children='.',style={'textAlign':'center','color':'black',
            "background-image": 'url("/assets/terror.jpg")','background-position':'right top',
                    "background-size":'300px 70px'}),
            html.H1(id='Main_title',children='TERRORISM ANALYSIS WITH INSIGHTS',style={'textAlign':'center',
            'color':'white', 'font-weight':'bolder','background-color':'green'
            }),
            html.Div('PROJECT BY- BHOOMIKA PUNJABI B.Tech (Amity University)',
                        ...
                        [
                            dcc.Tabs(id='sub-tab1',value='tab-1',children=[
                                dcc.Tab(label='WORLD MAP TOOL',id='world-map-tool',value='tab-1', loading_state=True, children=[html.Div([
                                    ...
                                    html.Div('SELECT YEAR RANGE',style=({'font-weight':'bolder',
                                        'color':'WHITE'})),
                                    dcc.RangeSlider(
                                        id='year-slider',
                                        min=min(year_list),
                                        ...
                                        marks=year_dict),
                                    html.Br(),
                                    html.H3(id='info',children=None,style=({'color':'white','font-weight':'bolder'})),
                                ...
                                dcc.Tab(label='INDIA MAP TOOL',id='india-map-tool',value='tab-1a',children=[
                                    ...
                                    html.H5(style=({'font-weight':'bolder','color':'WHITE'}),id='year-title1',children='Select year range'),
                                    dcc.RangeSlider(
                                        id='year-slider1',
                                        min=min(year_list),
                                        max=max(year_list),
                                        ...
                                        marks=year_dict),
                                    html.Br(),
                                    html.H3(id='info1',children=None,style=({'color':'WHITE','font-weight':'bolder'})),
                        ...
                        [
                            dcc.Tabs(id='sub-tab2',value='chart-1',children=[
                                dcc.Tab(label='WORLD CHART TOOL',id='world-chart-tool',value='chart-1',children=[
                                    ...
                                    html.Hr(),
                                    html.H4(id='text',
                                   children= "Please type your filter search below and press Enter",
...
def update_app_ui(month_value,date_value,region_value,country_value,state_value,city_value,attack_value,year_value):
    ...
    if len(dfa.index)==0:
        ...
        children='No records avaiable for the specific selections made'
    else:
        pass
